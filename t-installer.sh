...
ctrl_c() {
clear
echo -b $green"[•]> THAT TOOLS YOU INSTALL IN THE DIRECTORY OF THE CAVE" |lolcat
echo -b $green"[•]> Thanks For Using My Tools" |lolcat
sleep 1
echo -b $green"[•]> T-INSTALLER On Your System" |lolcat
...
echo -e "PLEASE WAIT AND LOOK AT THE LIST OF TOOLS" | lolcat
echo ""
echo -e "============================" | lolcat
...
00) echo "AUTHOR: STEPHIN-FRANKLIN" | lolcat
echo "T-INSTALLER IS NOW ON YOUR SYSTEM" | lolcat
echo " THAT TOOLS YOU INSTALL IN THE DIRECTORY OF THE CAVE" | lolcat
figlet T-INSTALLER | lolcat
exit
;;

*) echo "Sorry, Your choices it's not already [T-INSTALLER]"
esac
done
done
